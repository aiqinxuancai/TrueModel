...
内置默认指纹库为 ModelTrace 提交 `55a2e4a55170423b484d701e9a82ab62b268c811`，包含 16 个模型。启动不会自动升级已有库。在指纹库页面点击“检查默认库更新”，从 ModelTrace GitHub 下载最新版本并校验；相同内容不重复入库。新版保存后可手动设为当前库，保留原库和历史记录。
